...
var (
	...
	redditSites = [3]string{
		...
		"https://old.reddit.com/r/soccer/search?q=liverpoolMac&restrict_sr=on&sort=top&t=day",
		"https://old.reddit.com/r/LiverpoolFC/top/",
	}

	// team schedule from Bleacher Report url
	brSite = "https://bleacherreport.com/liverpoolMac/schedule"
	// team soccer reference url
	soccerRef = "https://fbref.com/en/squads/822bd0ba/Liverpool"
	...
	instagram = "https://www.instagram.com/liverpoolfc/?hl=en"
	// team ESPN page url
	espn = "http://www.espn.com/soccer/team/_/id/364/liverpoolMac"
	// official team website url
	teamSite = "https://www.liverpoolfc.com/"
	// team whoScored page url
	whoScored = "https://www.whoscored.com/Teams/26/Show/England-Liverpool"
...
func main() {
	...
	r.PathPrefix("/liverpoolMac-logo.jpg").Handler(http.FileServer(box.HTTPBox()))
	r.PathPrefix("/liverpoolMac-favicon.ico").Handler(http.FileServer(box.HTTPBox()))
